...
class RecipeView extends Views {
  ...
  _generateMarkupIngredient(ing) {
    return ` <li class="recipe__ingredient">
            ...
            <div class="recipe__quantity">${styleNumber(ing.quantity)}</div>
